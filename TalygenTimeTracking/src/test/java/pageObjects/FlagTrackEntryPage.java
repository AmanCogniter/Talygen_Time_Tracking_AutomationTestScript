...
public class FlagTrackEntryPage extends WebBasePage {
	...
	/*
	 * @FindBy(xpath =
	 * "//div/span[contains(text(),'The entry has been successfully Flagged')]")
	 * private WebElement notifymessagePopUp;
	 * 
	 * public String getNotifymessagePopUp() { return notifymessagePopUp.getText();
	 * }
	 */
	...
	public void clickTimeTrackingLink() {
		clickByJavascript(By.xpath(
				"//div/ul/li[@data-name='Time Tracking']/span"),
				"Time Tracking", 30);
		staticWait(2000);
	}
	...
	public void FlagTrackEntrypage() {
		staticWait(3000);
		try {
			WebElement tourguide = driver.findElement(
					By.xpath("//div[@class='guided-tour-step-footer']/span[@title='End tour']/*[name()='svg']"));
			...
			if (tourguide.isDisplayed() && flagTrackEntry.contains(prop.getProperty("flagTrackEntry"))) {
				click(By.xpath("//div[@class='guided-tour-step-footer']/span[@title='End tour']/*[name()='svg']"),
						"close tour guide", 30);
				staticWait(2000);
	...
	public void enterUnflagCommentTitle() {
		staticWait(2000);
		enter(By.xpath("//div/textarea[@id='CommentTitle']"), prop.getProperty("unflagTitle"), "UnFlage Comment title",
				30);
		;
	...
	public void enterCommentDescription() {
		staticWait(2000);
		enter(By.xpath("//div/textarea[@id='CommentDescription']"), prop.getProperty("commentDescription"),
				"Comment description", 30);
		;
	...
	public void enterUnFlagCommentDescription() {
		staticWait(2000);
		enter(By.xpath("//div/textarea[@id='CommentDescription']"), prop.getProperty("unFlagcommentDescription"),
				"UnFlagComment description", 30);
		;
	...
	public void clickOnPostComment() {
		...
		/*
		 * staticWait(1000); WebElement flagseccessMessage = driver.findElement(By.
		 * xpath("//div/span[contains(text(),'The entry has been successfully Flagged')]"
		 * )); staticWait(1000); logger.info(flagseccessMessage); if
		 * (flagseccessMessage.isDisplayed()) {
		 * logger.info("The entry has been successfully Flagged"); } else {
	...
	public void clickOnUnflagPostComment() {
		...
		/*
		 * staticWait(3000); WebElement flagseccessMessage = driver .findElement(By.
		 * xpath("//div/span[contains(text(),'The entry has been successfully UnFlagged')]"
		 * )); if (flagseccessMessage.isDisplayed()) {
		 * logger.info("The entry has been successfully UnFlagged"); } else {
